...
- `src/silk/nlsf_decode.rs` ports the predictive stage-two NLSF decoder that reconstructs quantised LPC coefficients from codebook indices, mirroring `silk/NLSF_decode.c` while reusing the existing unpacking and stabilisation helpers.【src/silk/nlsf_decode.rs†L1-L133】【opus-main/silk/NLSF_decode.c†L33-L103】
