...
- `src/silk/biquad_alt.rs` reproduces the alternative second-order ARMA filter used during resampling and bandwidth switching, handling both stride-one and stride-two sample layouts exactly as in `silk/biquad_alt.c`.【src/silk/biquad_alt.rs†L1-L171】
