...
- `src/silk/resampler_rom.rs` provides the coefficient ROM shared by SILK's fixed-point resamplers, mirroring the lookup tables from `silk/resampler_rom.c` and `silk/resampler_rom.h`.【src/silk/resampler_rom.rs†L1-L102】
