...
- Helper utilities such as `sum_sqr_shift.c`, `interpolate.c`, `log2lin.c`, and table files (`tables_*.c`, `table_LSF_cos.c`) supply math helpers and lookup data; Rust now mirrors the `sum_sqr_shift`, `log2lin`, `interpolate`, `tables_pitch_lag`, and `tables_pulses_per_block` helpers via `src/silk/sum_sqr_shift.rs`, `src/silk/log2lin.rs`, `src/silk/interpolate.rs`, `src/silk/tables_pitch_lag.rs`, and `src/silk/tables_pulses_per_block.rs`, but the remaining lookup tables stay in C.【28a6dc†L1-L44】【a6d7bc†L1-L48】【src/silk/sum_sqr_shift.rs†L1-L101】【src/silk/log2lin.rs†L1-L71】【src/silk/interpolate.rs†L1-L74】【src/silk/tables_pitch_lag.rs†L1-L29】【src/silk/tables_pulses_per_block.rs】
