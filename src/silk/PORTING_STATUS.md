...
- `src/silk/lpc_inv_pred_gain.rs` ports the fixed-point LPC stability check and inverse prediction gain helper used across the SILK pipeline, mirroring `silk/LPC_inv_pred_gain.c`.【src/silk/lpc_inv_pred_gain.rs†L1-L209】【opus-c/opus-main/silk/LPC_inv_pred_gain.c†L1-L112】
