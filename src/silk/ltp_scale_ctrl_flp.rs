...
pub fn ltp_scale_ctrl_flp(
    ...
    if matches!(cond_coding, ConditionalCoding::Independent) {
        ...
        let threshold0 = log2lin(2900 - common.snr_db_q7);
        if gain_weight > threshold0 {
            scale_index += 1;
        }
        let threshold1 = log2lin(3900 - common.snr_db_q7);
...
mod tests {
    ...
    fn conditional_coding_forces_default_scale() {
        ...
        let scale =
            ltp_scale_ctrl_flp(&common, &mut indices, ConditionalCoding::Conditional, 120.0);
